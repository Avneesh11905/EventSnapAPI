...
from domain.exceptions import FaceValidationError, InvalidReferenceImagesError
...
async def test_encode_attendee_use_case_no_faces():
    ...
    use_case = EncodeAttendeeUseCase[str](
        inference_service=mock_inference, augmenter=MagicMock(), decode_fn=lambda x: x
    )
