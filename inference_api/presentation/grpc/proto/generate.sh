...
INFERENCE_API_ROOT="$(cd "$SCRIPT_DIR/../../../.." && pwd)"
...
python -m grpc_tools.protoc \
    --proto_path="$INFERENCE_API_ROOT" \
    --python_out="$INFERENCE_API_ROOT" \
    --grpc_python_out="$INFERENCE_API_ROOT" \
    "presentation/grpc/proto/inference.proto"
